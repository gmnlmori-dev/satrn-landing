          ...
          {steps.map((step, index) => (
            <li key={step.title}>
              <Reveal className="h-full">
                <article className="relative h-full rounded-[12px] border border-slate-200/90 bg-slate-50/30 p-6 shadow-sm shadow-slate-900/[0.035] transition-[box-shadow,transform,border-color] duration-200 hover:-translate-y-0.5 hover:border-slate-300/90 hover:shadow-md hover:shadow-slate-900/[0.06]">
                  <span className="text-xs font-semibold uppercase tracking-wider text-blue-700/85">
                    Step {index + 1}
                  </span>
